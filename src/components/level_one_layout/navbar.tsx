...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-transparent relative z-50 border border-bottom-1 border-[#D6E4FF]">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <Link
                href="/about"
                className="text-[#021241] hover:text-[#3466FF] px-3 py-2 text-base font-medium transition-colors"
              >
                About
              </Link>
              <Link
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-[#3466FF] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
              aria-expanded="false"
            >
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 shadow shadow-blue-100">
            <Link
              href="/about"
              className="text-gray-700 hover:text-[#3466FF] block px-3 py-2 text-base font-medium transition-colors"
