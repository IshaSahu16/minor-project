...
export default function DetectFake() {
  ...
  return (
    <section className="min-h-screen bg-background flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-16">
      <div className="max-w-4xl mx-auto w-full space-y-8">
        {/* Header */}
        <div className="text-center space-y-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-primary-text">
            Detect the <span className="text-primary">Truth</span>
          </h1>
          <p className="text-lg sm:text-xl text-secondary-text max-w-3xl mx-auto leading-relaxed">
